...
```{r, eval = FALSE}
library(Matrix)
Titan_Inputmatrix = sparse.model.matrix( Survived ~ Sex + Age + Pclass + Fare, data = TTrain)
...
```{r, eval = FALSE}
Titan_Testmatrix = sparse.model.matrix( Survived ~ Sex + Age +Pclass + Fare, data = TTest)
