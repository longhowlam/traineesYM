...
Eerst wat preparatie van de teksten 
```{r}
#### prep functie
...
# gebruik bovenstaande prep functie om RedenBezwaar te bewerken
NOS = NOS %>% 
  mutate(
    id = 1:n(),
    art = prep_fun(art),
...
summary(NOS$NWoorden)
hist(NOS$NWoorden, nclass  =100)
```
...
```{r eval = FALSE}
## pak nu alleen Nederlandse bezwaren met meer dan 7 woorden
NOS = NOS %>% 
  filter(
    NWoorden > 20
  ) 

######## Tokenize en maak vocabulaire ###################################################
...
# haal te weinig en ook te veel voorkomende woorden weg
...
wordcloud2(pruned_vocab, shape = "star")
...
### resultaat in de vorm van tabel ###########
